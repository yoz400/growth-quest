...
(function () {
  ...
  const OTOMON_MASTER = [
    ...
    { id:'tsuyukusa_pixie', name:'ツユクサピクシー', rarity:'R', attribute:'study', type:'study',
      ...
      image:{
        original:'assets/otomon/tsuyukusa_pixie/source/tsuyukusa_pixie_original.webp',
        large:'assets/otomon/tsuyukusa_pixie/1024/tsuyukusa_pixie_1024.webp',
        medium:'assets/otomon/tsuyukusa_pixie/256/tsuyukusa_pixie_256.webp',
        small:'assets/otomon/tsuyukusa_pixie/64/tsuyukusa_pixie_64.webp',
      },
      favoriteItem:'はじまりの種',
    ...
    { id:'amedama_slime', name:'あめだまスライム', rarity:'R', attribute:'recover', type:'recover',
      ...
      image:{
        original:'assets/otomon/amedama_slime/source/amedama_slime_original.webp',
        large:'assets/otomon/amedama_slime/1024/amedama_slime_1024.webp',
        medium:'assets/otomon/amedama_slime/256/amedama_slime_256.webp',
        small:'assets/otomon/amedama_slime/64/amedama_slime_64.webp',
      },
    ...
    { id:'mame_drako',      name:'まめドラコ',     rarity:'R',   attribute:'exercise', type:'exercise',
      ...
      image:{
        original:'assets/otomon/mame_drako/source/mame_drako_original.webp',
        large:'assets/otomon/mame_drako/1024/mame_drako_1024.webp',
        medium:'assets/otomon/mame_drako/256/mame_drako_256.webp',
        small:'assets/otomon/mame_drako/64/mame_drako_64.webp',
      },
    ...
    { id:'korokoro_iwamogu', name:'ころころ岩モグ', rarity:'R', attribute:'organize', type:'organize',
      ...
      image:{
        original:'assets/otomon/korokoro_iwamogu/source/korokoro_iwamogu_original.webp',
        large:'assets/otomon/korokoro_iwamogu/1024/korokoro_iwamogu_1024.webp',
        medium:'assets/otomon/korokoro_iwamogu/256/korokoro_iwamogu_256.webp',
        small:'assets/otomon/korokoro_iwamogu/64/korokoro_iwamogu_64.webp',
      },
...
(function () {
  ...
  const BUDDY_TRIGGER_LINES = {
    ...
    // ── trigger個体別 第2弾 Batch1（20体）※master順の未実装先頭20 ──
    tsuyukusa_pixie: {
      timer_start:      { 1:'そっと、はじめてみよ。', 2:'朝のしずくみたいに、ちいさく。', 3:'きみのペースで、いこ。', 4:'となりで、そっと見てるね。', 5:'きみとなら、朝みたいに気持ちよく始められる。' },
      session_complete: { 1:'ちゃんとできたね。えらい。', 2:'きょうの一滴、きれいだったよ。', 3:'きみのがんばり、朝露みたいに光ってる。', 4:'よくやったね。すごいよ。', 5:'きみと迎えた朝、いちばんきれいだったな。' },
    },
    amedama_slime: {
      timer_start:      { 1:'あまい気分で、はじめよ。', 2:'むりせず、ひとくちずつね。', 3:'きみとだと、なんでも甘くなる。', 4:'つかれたら、とかしてあげる。', 5:'きみと過ごす時間、はじめから甘いね。' },
      session_complete: { 1:'おつかれさま。あまいの、どうぞ。', 2:'よくがんばったね。ほっとするね。', 3:'きみの笑顔、あまくて好きだよ。', 4:'すごいね。とろけそうなくらい。', 5:'きみとの今日、いつまでも甘くやさしい。' },
    },
    nemuri_hitsuji: {
      timer_start:      { 1:'……ふぁ。そっと、はじめよ。', 2:'いち、にひき……よし、いこ。', 3:'きみとなら、しゃきっとできる。', 4:'むりしないで。となりにいるよ。', 5:'きみと始める朝、いい夢のつづきみたい。' },
      session_complete: { 1:'よくできたね。ゆっくり休も。', 2:'がんばったね。ふかふかで待ってる。', 3:'きみの一日、ちゃんと見てたよ。', 4:'えらいね。ぐっすり眠れそう。', 5:'きみとの今日、いい夢になりそうだよ。' },
    },
    korokoro_iwamogu: {
      timer_start:      { 1:'ころん。ひと掘り、いこう。', 2:'ぼちぼち、掘りはじめよ。', 3:'きみとだと、掘るのが楽しいな。', 4:'どんな岩でも、いっしょに崩そう。', 5:'きみとなら、地の底まで進めるよ。' },
      session_complete: { 1:'よし、ひと山越えたな。', 2:'こつこつ掘れたね。えらい。', 3:'きみの積み重ね、岩みたいに固いよ。', 4:'すごいな、よく掘りきった！', 5:'きみと掘ったこの道、りっぱなもんだ。' },
    },
    madoromi_kurage: {
      timer_start:      { 1:'ふよ……ゆっくり、はじめよ。', 2:'とろん。ちょっとだけ、ね。', 3:'きみの波に、そっと乗るよ。', 4:'むりのない速さで、ただよおう。', 5:'きみと漂うこの時間、心地いいね。' },
      session_complete: { 1:'ふわ、よくやったね。', 2:'いいながれだったね。おつかれ。', 3:'きみのがんばり、波に感じたよ。', 4:'すごいね。ぷかぷか嬉しい。', 5:'きみと漂った今日、いちばん穏やかだった。' },
    },
    nemuke_baku: {
      timer_start:      { 1:'わるい眠気は、食べとくよ。', 2:'すっきり、はじめよっか。', 3:'きみが集中できるよう、そばにいる。', 4:'気がかりは、ぼくが預かるよ。', 5:'きみの時間、いい夢みたいに守るね。' },
      session_complete: { 1:'おつかれさま。よくがんばった。', 2:'やりきったね。ゆっくり休も。', 3:'きみの一日、ちゃんと見届けたよ。', 4:'えらいね。いい夢が待ってる。', 5:'きみのがんばり、ぜんぶいい夢に変えるよ。' },
    },
    mayoke_fukurou: {
      timer_start:      { 1:'ホゥ。じゃまものは、寄せつけない。', 2:'さあ、はじめよう。見てるよ。', 3:'きみの集中、ぼくが守る。', 4:'気を散らすものは、ぼくが追う。', 5:'きみの時間、どんな夜も見張るよ。' },
      session_complete: { 1:'よくやった。見ていたよ。', 2:'ちゃんと進んだね。えらい。', 3:'きみのがんばり、この目で見届けた。', 4:'見事だ。きみは頼もしいな。', 5:'きみと過ごすこの時間、ずっと守りたい。' },
    },
    petit_mimic: {
      timer_start:      { 1:'パカッ。宝さがし、はじめる？', 2:'きょうのぶん、ためていこ。', 3:'きみとだと、宝もよく集まるね。', 4:'がんばりは、ぜんぶしまっとくよ。', 5:'きみといる時間が、いちばんの宝だ。' },
      session_complete: { 1:'おっ、ひとつ宝が増えたね。', 2:'よくやった、ごほうびあげちゃう。', 3:'きみのがんばり、宝箱いっぱいだ。', 4:'すごい！大当たりの一日だね。', 5:'この宝箱、きみとの思い出でいっぱいだ。' },
    },
    hosikuzukurage: {
      timer_start:      { 1:'ふわ。星ひとつ、拾ってみる？', 2:'きょうの光、ひとつ灯そう。', 3:'きみとだと、星がよく光るよ。', 4:'きみの夜空、ぼくが照らすね。', 5:'きみと漂う時間、星屑みたいにきれい。' },
      session_complete: { 1:'きらり。よくできたね。', 2:'きょうの光、ひとつ増えたよ。', 3:'きみのがんばり、夜空に増えてる。', 4:'すごいね。満天みたいだ。', 5:'きみと集めた星、いちばんの星屑だよ。' },
    },
    nejimakigoremu: {
      timer_start:      { 1:'カチ、コチ。動き出そう。', 2:'ねじ、ひと巻きから。', 3:'きみとだと、いい回転だ。', 4:'一定のリズムで、いこう。', 5:'きみのために、まわり続けるよ。' },
      session_complete: { 1:'よし、ちゃんと動いたな。', 2:'いい回転だった。おつかれ。', 3:'きみのリズム、狂いなく進んでる。', 4:'見事な仕事だ。えらいぞ。', 5:'きみと刻んだ今日、いい時計になった。' },
    },
    kinokorisu: {
      timer_start:      { 1:'ちょこん。ひとつ、拾お？', 2:'どんぐりみたいに、集めよ。', 3:'きみとだと、はかどるね。', 4:'きみのぶんも、集めておくよ。', 5:'きみといると、宝さがしみたいだ。' },
      session_complete: { 1:'たくさん拾えたね。えらい。', 2:'よくやった、ほくほくだね。', 3:'きみの積み上げ、しっかり見てたよ。', 4:'すごいね、大豊作だ！', 5:'きみと集めた今日、いちばんの宝物だ。' },
    },
    soyokazeferet: {
      timer_start:      { 1:'すー。ちょっと、風に乗ろ。', 2:'きょうはどっち行く？いこ。', 3:'きみとだと、追い風だね。', 4:'きみのペースで、軽くいこう。', 5:'きみの隣が、いちばんいい風だ。' },
      session_complete: { 1:'いい風だったね。おつかれ。', 2:'よく走ったね。えらい。', 3:'きみのがんばり、風で感じたよ。', 4:'すごい、すいすいだったね！', 5:'きみと駆けた今日、最高に気持ちよかった。' },
    },
    koripengin: {
      timer_start:      { 1:'すい。あわてず、いこう。', 2:'きょうもひんやり、ゆっくりね。', 3:'きみとだと、いいペースだ。', 4:'落ち着いていこう。ぼくがいる。', 5:'きみとなら、寒い日もあったかい。' },
      session_complete: { 1:'よくやったね。ひと休みしよ。', 2:'いいペースだった。おつかれ。', 3:'きみの冷静さ、頼もしいよ。', 4:'見事だね。すいすいだった。', 5:'きみと過ごす今日、あったかい気持ちだ。' },
    },
    ponpokotanukin: {
      timer_start:      { 1:'ぽんっ。気楽に、いこか。', 2:'ぽこぽこ♪ ひとつ、いっとく？', 3:'きみとだと、のってくるなァ。', 4:'おなかの太鼓で、応援するよ。', 5:'相棒、いくぞ！お祭りみたいにな！' },
      session_complete: { 1:'よくやった！ぽんぽん。', 2:'いいねいいね、大成功だ！', 3:'きみのがんばり、ばっちり見てた。', 4:'すごいぞ、踊りたくなるなァ！', 5:'きみといる今日も、お祭りみたいだ！' },
    },
    chibigurifon: {
      timer_start:      { 1:'ふん。小さいけど、やるよ。', 2:'ちょっと、飛んでみようか。', 3:'きみとなら、高く行けそう。', 4:'ぼくの翼、きみのために広げる。', 5:'相棒、いくよ！大空まで！' },
      session_complete: { 1:'よくやった。ぼくも見てたよ。', 2:'ちゃんと飛べたね。えらい。', 3:'きみのがんばり、翼で感じた。', 4:'すごいぞ、高く飛べたね！', 5:'きみと目指す空、もうすぐそこだ。' },
    },
    hapakamereon: {
      timer_start:      { 1:'…そっと、はじめよ。', 2:'こっそり、応援してる。', 3:'きみの前なら、隠れずいられる。', 4:'となりで、ちゃんと見てるよ。', 5:'きみといると、色がぱっと明るくなる。' },
      session_complete: { 1:'できたね。えらいよ。', 2:'よくがんばった。見てたよ。', 3:'きみのがんばり、ちゃんと見えてる。', 4:'すごいね。色が輝いてるよ。', 5:'きみと過ごす今日、いちばん鮮やかだ。' },
    },
    mizutamakabankuru: {
      timer_start:      { 1:'ぽわ。ひとつ、ひらめこ。', 2:'額の宝石、きょうも光ってる。', 3:'きみとだと、いい考えが浮かぶ。', 4:'きみのアイデア、いっしょに磨こう。', 5:'きみとぼくで、宝石みたいな日にしよ。' },
      session_complete: { 1:'きらり。よくできたね。', 2:'いいひらめきだった。おつかれ。', 3:'きみのがんばり、きらきらしてる。', 4:'すごいね、宝石みたいだ。', 5:'きみと磨いた今日、最高の輝きだよ。' },
    },
    sabinejiinpu: {
      timer_start:      { 1:'ギィ。ちょっとサビてるけど、やる。', 2:'ネジ、ひと締めから。', 3:'きみとだと、油がさしたみたい。', 4:'きみとなら、ガタつかないよ。', 5:'きみとなら、どんなガタつきも直せる。' },
      session_complete: { 1:'よし、ちゃんと回ったな。', 2:'いい仕事だった。おつかれ。', 3:'きみのがんばり、しっかり見てた。', 4:'見事だ、なめらかだったな！', 5:'きみと直した今日、いい調子だ。' },
    },
    moguransa: {
      timer_start:      { 1:'ずぼっ。ひと掘り、いこう。', 2:'こつこつ、掘りはじめよ。', 3:'きみのがんばり、地中で感じる。', 4:'どんな壁も、ぼくが掘るよ。', 5:'きみとなら、地の果てまで掘れる。' },
      session_complete: { 1:'よし、掘りきったな。', 2:'いい仕事だった。えらい。', 3:'きみの積み重ね、ちゃんと届いてる。', 4:'すごいぞ、突き進んだね！', 5:'きみと掘ったこの道、遠くまで続いてる。' },
    },
    sirotamayuniko: {
      timer_start:      { 1:'こんにちは。ゆっくり、はじめよ。', 2:'角がね、ちょっと光ったよ。', 3:'きみの願い、そっと後押しする。', 4:'きみのそばだと、角がよく光る。', 5:'きみと歩く道、いつもやさしく光ってる。' },
      session_complete: { 1:'よくできたね。えらい。', 2:'いいがんばりだった。おつかれ。', 3:'きみのがんばり、角が照らしてる。', 4:'すごいね、まぶしいくらいだ。', 5:'きみと過ごす今日、いちばん白く輝いてる。' },
    },
    // ── trigger個体別 第2弾 Batch2（20体）※master順の未実装 21〜40 ──
    hotaruuruhu: {
      timer_start:      { 1:'ぽう。ひとつ、灯そうか。', 2:'足もと、照らしておくね。', 3:'きみの集中、ぼくの光がまもる。', 4:'迷っても平気。先に光ってるよ。', 5:'きみの道、ずっと灯し続けるよ。始めよう。' },
      session_complete: { 1:'よく灯したね。おつかれ。', 2:'いい光だった。ちゃんと進んだね。', 3:'きみのがんばり、暗くても見えてたよ。', 4:'見事だ。まぶしいくらいだったよ。', 5:'きみと照らした今日、きれいな夜になった。' },
    },
    kazekiritubaneryu: {
      timer_start:      { 1:'すいっ。風、きってみる？', 2:'きょうはどこ行く？さきに見てくる。', 3:'きみとなら、追い風になれる。', 4:'おそくても平気。きみのペースで。', 5:'きみの隣が、いちばんいい空だ。飛ぼう。' },
      session_complete: { 1:'いいフライトだったね。おつかれ。', 2:'よく飛んだね。えらい。', 3:'きみのがんばり、風で感じたよ。', 4:'見事だ、ぐんと伸びたね！', 5:'きみと切ったこの空、最高だったよ。' },
    },
    kuristalrabit: {
      timer_start:      { 1:'ぴょこ。そっと、はじめよ。', 2:'きょうも、ちいさくひと跳ね。', 3:'きみといると、澄んだ音がする。', 4:'きみの前なら、安心して跳ねられる。', 5:'きみとの時間、透きとおってきれい。始めよ。' },
      session_complete: { 1:'きれいに跳べたね。えらい。', 2:'いい音だった。よくやったね。', 3:'きみのがんばり、澄んで響いてる。', 4:'すごいね、きらきらしてる。', 5:'きみと過ごす今日、透きとおってきれいだよ。' },
    },
    donguritorent: {
      timer_start:      { 1:'よいしょ。ゆっくり、根をはろう。', 2:'きょうも一枚、葉をふやそ。', 3:'あわてない。少しずつでいい。', 4:'きみの成長、そばで見守るよ。', 5:'きみと育てるこの森、大きくなるね。' },
      session_complete: { 1:'よく育ったね。ひと息つこ。', 2:'いい一日だった。えらい。', 3:'きみの成長、年輪みたいに刻まれてる。', 4:'見事だ、ぐんと伸びたね。', 5:'きみと育てたこの森、りっぱになったよ。' },
    },
    huwakumoramu: {
      timer_start:      { 1:'ふわぁ。むりせず、ぷかぷか。', 2:'きょうも、やわらかくいこ。', 3:'きみとだと、心も軽くなる。', 4:'重荷は、雲みたいに軽くするね。', 5:'きみといると、空までふわっと上がれそう。' },
      session_complete: { 1:'ふわ、よくやったね。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ふんわり届いてるよ。', 4:'すごいね、雲の上の気分だ。', 5:'きみと過ごす今日、いちばんやわらかい。' },
    },
    hinokosaramanda: {
      timer_start:      { 1:'ぱち。ちいさく、火をつけよ。', 2:'ひとがんばり、いってみる？ぼくも燃える。', 3:'きみのやる気、あたためるよ。', 4:'消えかけても平気。火はつぐよ。', 5:'きみとぼくの火、いくよ。燃やそう。' },
      session_complete: { 1:'いい火だったね。よくやった。', 2:'ちゃんと燃えたね。えらい。', 3:'きみのやる気、ずっと感じてたよ。', 4:'見事だ、熱かったね！', 5:'きみとぼくの火、今日もよく燃えたよ。' },
    },
    koganekoganemusi: {
      timer_start:      { 1:'ころん。こつこつ、いこ。', 2:'きょうのぶん、ちいさく貯めよ。', 3:'きみの努力、金色に光ってる。', 4:'いい積み重ね。福がついてくるよ。', 5:'きみといる毎日が、いちばんの宝だ。' },
      session_complete: { 1:'よく貯めたね。えらい。', 2:'いい積み重ねだった。おつかれ。', 3:'きみのがんばり、金色に光ってるよ。', 4:'すごいね、福が転がってきそう。', 5:'きみと積んだ今日、まぶしい宝だなあ。' },
    },
    mohumohuyeti: {
      timer_start:      { 1:'もふ。さむくない？そばにおいで。', 2:'きょうも、あったかくいこ。', 3:'きみとだと、ぽかぽか進める。', 4:'つかれたら、もふもふに埋もれていい。', 5:'きみといると、雪山もあったかいよ。' },
      session_complete: { 1:'よくやったね。あったまろ。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと見てたよ。', 4:'すごいね、ぽかぽかするよ。', 5:'きみと過ごす今日、雪山もぽかぽかだ。' },
    },
    sunanekomata: {
      timer_start:      { 1:'ふん。すなに足あと、つけてく？', 2:'にゃ。きょうも、付き合うよ。', 3:'きみのとなり、わるくないね。', 4:'尻尾ふたつで、応援してやる。', 5:'きみとなら、どこまでも歩けるよ。いこ。' },
      session_complete: { 1:'ふん、やるじゃない。', 2:'にゃ、よくやったね。', 3:'きみのがんばり、ちゃんと見てた。', 4:'見事だ、さすがだね。', 5:'砂漠のどこにいても、きみのとこへ帰るよ。' },
    },
    runetokage: {
      timer_start:      { 1:'古い印を、ひとつ。はじめよう。', 2:'きょうの一文字、きざもう。', 3:'きみの歩み、記録しておくよ。', 4:'きみの努力、ルーンに刻むよ。', 5:'きみとの時間が、美しい呪文になる。' },
      session_complete: { 1:'よく刻めたね。おつかれ。', 2:'いい一文字だった。えらい。', 3:'きみのがんばり、ちゃんと記した。', 4:'見事だ、力ある印だよ。', 5:'きみと綴った今日、いちばん美しい呪文だ。' },
    },
    minaraifenikkusu: {
      timer_start:      { 1:'まだ見習いだけど、がんばるっ。', 2:'何度でも、やりなおせるよ。いこ。', 3:'きみとだと、うまく燃えられる。', 4:'転んでも、火はつけ直すよ。', 5:'きみとなら、何度でも生まれ変われる。' },
      session_complete: { 1:'よくやった！ぼくも燃えたよ。', 2:'ちゃんとやりきったね。えらい。', 3:'きみのがんばり、羽で感じた。', 4:'すごいぞ、高く昇れたね！', 5:'きみと昇るこの空、何度でも見たいよ。' },
    },
    yukidamagoburin: {
      timer_start:      { 1:'ころっ。ゆきだま、作る？', 2:'ちいさく転がすほど、大きくなるよ。', 3:'きみとだと、止まらないや！', 4:'いっしょに転がそう。どんどんね。', 5:'きみとの毎日、大きなゆきだまだ！' },
      session_complete: { 1:'よく転がしたね！', 2:'いいねいいね、大きくなった！', 3:'きみのがんばり、ばっちり見てた。', 4:'すごいぞ、まんまる大成功！', 5:'きみと転がした今日、大きなゆきだまだ！' },
    },
    sizukuseiren: {
      timer_start:      { 1:'ぽつん。ちいさく、歌おう。', 2:'きょうの一滴、きれいな音。', 3:'きみのために、歌をうたうね。', 4:'つかれたら、この声で癒やすよ。', 5:'きみと奏でる時間、いちばんの調べ。' },
      session_complete: { 1:'いい響きだったね。おつかれ。', 2:'よく歌えたね。えらい。', 3:'きみのがんばり、きれいな音がした。', 4:'見事だね、澄んだ調べだ。', 5:'きみと重ねた今日、最高の一曲になった。' },
    },
    tubomimantisu: {
      timer_start:      { 1:'まだつぼみ。あせらず、ね。', 2:'きょうも少し、ひらきかけてる。', 3:'きみのおかげで、咲く準備ができた。', 4:'きみとなら、ちゃんと花ひらける。', 5:'満開まで、きみと咲かせていこう。' },
      session_complete: { 1:'ひとひら、ひらいたね。えらい。', 2:'いいがんばりだった。おつかれ。', 3:'きみのがんばり、花になってきてる。', 4:'すごいね、もうすぐ満開だ。', 5:'きみと咲かせたこの花、いちばんきれいだ。' },
    },
    hosizorakitune: {
      timer_start:      { 1:'こんばんは。星、ひとつ数えよ。', 2:'きょうの夜空、きみと始めよう。', 3:'きみの願い、星に届けておくよ。', 4:'迷った夜も、ぼくが星で照らす。', 5:'きみとつなぐ星座、消えないよ。始めよ。' },
      session_complete: { 1:'星ひとつ、増えたね。', 2:'いい夜だった。よくやったね。', 3:'きみのがんばり、夜空に輝いてる。', 4:'すごいね、満天みたいだ。', 5:'きみとつないだ今日、きれいな星座になった。' },
    },
    karakurinezumi: {
      timer_start:      { 1:'チチッ。ぜんまい、ひと巻きから。', 2:'こつこつ動けば、歯車はまわる。', 3:'きみのリズム、ぼくとぴったり。', 4:'きみとなら、からくりも狂わない。', 5:'きみのために、まわり続けるよ。いこ。' },
      session_complete: { 1:'よし、ちゃんと回ったね。', 2:'いいリズムだった。おつかれ。', 3:'きみのがんばり、狂いなく進んでた。', 4:'見事だ、精密な一日だね。', 5:'きみと刻んだ今日、いいからくりになった。' },
    },
    kogumanaito: {
      timer_start:      { 1:'小さいけど、きみを守るよ。', 2:'きょうも一歩、前に出よう。', 3:'きみのそばだと、勇気がわく。', 4:'きみの盾に、ぼくがなる。', 5:'何があっても、きみの騎士でいるよ。いこ。' },
      session_complete: { 1:'よく戦ったね。えらい。', 2:'ちゃんと守りきったね。おつかれ。', 3:'きみのがんばり、そばで見てたよ。', 4:'見事だ、勇敢だったね！', 5:'きみと過ごすこの時間、ずっと守りたい。' },
    },
    aobadoreiku: {
      timer_start:      { 1:'わかば色の、はじめまして。', 2:'きょうも、ちいさく芽をのばそ。', 3:'きみといると、ぐんぐん育つ。', 4:'若い翼だけど、きみと飛べば強い。', 5:'きみと育った翼で、どこへでも。いこ。' },
      session_complete: { 1:'よく育ったね。えらい。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、芽になってるよ。', 4:'すごいぞ、ぐんと伸びたね！', 5:'きみと育てたこの翼、たくましくなった。' },
    },
    rubiisasori: {
      timer_start:      { 1:'ふん。とげは、しまっておくよ。', 2:'きょうくらい、付き合ってやろう。', 3:'きみの前では、力がぬける。', 4:'きみのことは、この身で守る。', 5:'ルビーより、きみとの時間が宝だ。いこ。' },
      session_complete: { 1:'ふん、よくやった。', 2:'いい仕事だった。えらいぞ。', 3:'きみのがんばり、ちゃんと見てた。', 4:'見事だ、鋭かったな！', 5:'きみと過ごした今日、ルビーより輝いてる。' },
    },
    sirotunoboa: {
      timer_start:      { 1:'ブフッ。まっすぐ、いこうぜ。', 2:'きょうも一歩、突き進もう。', 3:'きみとなら、勢い止まらないな。', 4:'どんな壁も、角で崩すよ。', 5:'きみと駆けるこの道、最高だ。いくぞ。' },
      session_complete: { 1:'よし、突き進んだな！', 2:'いい走りだった。えらい。', 3:'きみのがんばり、しっかり見てた。', 4:'すごいぞ、壁ぶち破ったね！', 5:'きみと駆けた今日、最高に気持ちよかった。' },
    },
    // ── trigger個体別 第2弾 Batch3（20体）※master順の未実装 41〜60 ──
    suzumetengu: {
      timer_start:      { 1:'ちゅん。ま、ぼちぼち行くか。', 2:'きょうはどこ飛ぶ？さきに見てくるぜ。', 3:'きみ、なかなかやるじゃん。', 4:'きみの背中、風で押すよ。', 5:'相棒、天までひとっ飛びだ！いくぜ。' },
      session_complete: { 1:'お、やったな。', 2:'いい飛びっぷりだったぜ。', 3:'きみのがんばり、ちゃんと見てた。', 4:'見事だ、大したもんじゃん！', 5:'きみとなら、天までひとっ飛びだったな！' },
    },
    kobinhomunkurusu: {
      timer_start:      { 1:'とぷん。びんの中から、はじめよ。', 2:'きょうの発見、ひとつ集めよ。', 3:'きみといると、世界がよく見える。', 4:'びんの外も、きみとなら怖くない。', 5:'きみと見る世界、きらきらしてる。いこ。' },
      session_complete: { 1:'ひとつ、見つかったね。', 2:'いい発見だった。おつかれ。', 3:'きみのがんばり、ちゃんと見てたよ。', 4:'すごいね、大発見だ！', 5:'きみが、ぼくを外へ連れ出してくれた。ありがと。' },
    },
    kuronekosyeido: {
      timer_start:      { 1:'にゃ。そっと、はじめよ。', 2:'きょうは、となりにいてやろう。', 3:'きみのかげに、ぼくがついてる。', 4:'暗い日も、そっと寄りそうよ。', 5:'きみのとなりが、いちばん落ち着く。いこ。' },
      session_complete: { 1:'にゃ、よくやったね。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、かげから見てたよ。', 4:'見事だね、さすがだ。', 5:'きみと過ごす今日、いちばん落ち着く時間だ。' },
    },
    fuusenporuka: {
      timer_start:      { 1:'ぷかっ。かるーく、いこう♪', 2:'きょうも、ひとつふくらまそ。', 3:'きみといると、心も浮くね♪', 4:'きみの気分、空まで持ちあげる！', 5:'きみとおどるこの毎日、ポルカだ♪' },
      session_complete: { 1:'よくやったね♪ ぷかぷか。', 2:'いいリズムだった。おつかれ♪', 3:'きみのがんばり、ふわっと届いてる。', 4:'すごいね、踊りたくなる♪', 5:'きみとおどった今日、最高のポルカだ♪' },
    },
    manmarukouramusi: {
      timer_start:      { 1:'くるん。あ、そっとはじめよ。', 2:'ちょっとずつ、殻からのぞくね。', 3:'きみの前なら、まるまらずいられる。', 4:'きみといると、殻をひらいていられる。', 5:'きみといれば、安心して進めるよ。いこ。' },
      session_complete: { 1:'できたね。えらい。', 2:'よくがんばった。おつかれ。', 3:'きみのがんばり、ちゃんと見えてたよ。', 4:'すごいね、殻から出た甲斐あったね。', 5:'きみは、ぼくが安心できる場所だよ。' },
    },
    kohakurizaado: {
      timer_start:      { 1:'ひなたで、ゆっくりはじめよ。', 2:'きょうも、あたたかくいこ。', 3:'きみのそばは、こはく色にあったかい。', 4:'あせらないで。ゆっくりでいい。', 5:'きみとの時間、こはくに閉じこめたい。いこ。' },
      session_complete: { 1:'よくやったね。ひなたで休も。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、あたたかく見てたよ。', 4:'すごいね、こはく色に輝いてる。', 5:'きみと過ごす今日、閉じこめておきたいな。' },
    },
    utatanedoragon: {
      timer_start:      { 1:'ぐぅ。ん、ちょっと起きるよ。', 2:'きょうも、ゆるっと始めよ。', 3:'きみのとなりだと、しゃきっとするな。', 4:'つかれたら、ぼくの背でひと休み。', 5:'きみといると、夢まであったかい。いこ。' },
      session_complete: { 1:'よくやったね。ひと眠りしよ。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、うとうとしながら見てた。', 4:'すごいね、目が覚めたよ。', 5:'きみと過ごす今日、いい夢みたいだった。' },
    },
    sakurasupuraito: {
      timer_start:      { 1:'はらり。ちいさく、はじめよ。', 2:'きょうも一枚、花びらひらこ。', 3:'きみの成長、春みたいでうれしい。', 4:'散ってもまた咲く。いこう。', 5:'きみと見る満開、忘れないよ。始めよ。' },
      session_complete: { 1:'ひとひら咲いたね。えらい。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、花びらみたいに舞ってる。', 4:'すごいね、もうすぐ満開だ。', 5:'きみと迎えた今日、最高の満開だった。' },
    },
    batibatisupaaku: {
      timer_start:      { 1:'ばちっ。スイッチ、入れる？', 2:'ぱちぱち♪ 軽く放電しとこ。', 3:'きみといると、電気が元気に流れる！', 4:'きみのやる気、ぼくが充電する！', 5:'つなげば最高の電流だ！いくよ！' },
      session_complete: { 1:'ばっちり通電したね！', 2:'いい放電だった。おつかれ。', 3:'きみのがんばり、びりびり感じた。', 4:'すごいぞ、フルチャージだね！', 5:'きみとぼく、今日も最高の電流だった！' },
    },
    doronkoookuretto: {
      timer_start:      { 1:'どろん。泥くさく、いこうや。', 2:'きょうも一掘り、どろんこ上等！', 3:'きみとだと、泥まみれも楽しい。', 4:'どんな泥道も、いっしょに進むぞ。', 5:'きみとなら、どこまでも掘れるぜ。いくぞ。' },
      session_complete: { 1:'よし、泥まみれで頑張ったな。', 2:'いい仕事だった。えらい。', 3:'きみのがんばり、しっかり見てたぞ。', 4:'すごいぞ、泥だらけの大金星だ！', 5:'きみと転がった今日、いい泥だったな。' },
    },
    ringowaamu: {
      timer_start:      { 1:'にょろ。りんご、ひとかじりする？', 2:'きょうも、もぐもぐ進もう。', 3:'きみといると、りんごが甘い。', 4:'きみのぶんの実、とっておくよ。', 5:'きみとかじる毎日、いちばん甘い。いこ。' },
      session_complete: { 1:'よく食べ進んだね。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、あまく実ってるよ。', 4:'すごいね、まるごと一個だ！', 5:'きみとかじった今日、いちばん甘かった。' },
    },
    kiramekiinkoryuu: {
      timer_start:      { 1:'ぴぴっ。ちょっと、おしゃべりする？', 2:'きょうのこと、ひとつ教えてよ♪', 3:'きみの声、まねしたくなる。', 4:'きみの好きな言葉、覚えたよ。', 5:'おしゃべり、いちばんきらめく時間だ！いこ。' },
      session_complete: { 1:'よくやったね、ぴぴっ♪', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと聞いてた。', 4:'すごいね、きらきらだ！', 5:'きみとのおしゃべり、いちばんきらめく時間だ。' },
    },
    kotukotusukeruton: {
      timer_start:      { 1:'カタッ。こつこつ、いこうか。', 2:'地道がいちばん。骨身にしみる。', 3:'きみの積み重ね、よく知ってるよ。', 4:'焦らなくていい。骨は逃げない。', 5:'きみと積むこの日々、宝だ。いこ。' },
      session_complete: { 1:'よし、こつこつ進んだな。', 2:'いい積み重ねだった。おつかれ。', 3:'きみのがんばり、骨身で感じた。', 4:'見事だ、地道が実ったね。', 5:'きみと積んだ今日、骨のずいまで宝だ。' },
    },
    himitumomonga: {
      timer_start:      { 1:'そっ。ないしょで、はじめよ。', 2:'きょうのひみつ、ひとつ分けてあげる。', 3:'きみになら、秘密を話せる。', 4:'きみとなら、どこへでも滑空できる。', 5:'きみは、ぼくのいちばんのひみつだよ。いこ。' },
      session_complete: { 1:'そっと、よくやったね。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、こっそり見てたよ。', 4:'すごいね、内緒にしとくのもったいない。', 5:'きみと過ごす今日が、いちばん大切なひみつだ。' },
    },
    wataamebiisuto: {
      timer_start:      { 1:'ふわ。あまいの、ひとくちどう？', 2:'きょうも、ふんわりいこ。', 3:'きみといると、心までとろける。', 4:'つかれたら、わたあめに埋もれて。', 5:'きみとの時間、甘くやわらかい。いこ。' },
      session_complete: { 1:'おつかれさま。あまいの、どうぞ。', 2:'いい一日だった。ほっとするね。', 3:'きみのがんばり、ふんわり届いてる。', 4:'すごいね、とろけそうだ。', 5:'きみとの今日、いつまでも甘くやわらかい。' },
    },
    konpeitoufearii: {
      timer_start:      { 1:'きらっ。ちいさな一粒、どうぞ。', 2:'きょうのごほうび、ひとつ♪', 3:'きみのがんばり、あまく光ってる。', 4:'とっておきの粒、あるんだ。', 5:'きみとの毎日、宝石みたいな一粒だ。いこ。' },
      session_complete: { 1:'よくやったね、ひと粒どうぞ。', 2:'いい一日だった。おつかれ♪', 3:'きみのがんばり、あまく光ってるよ。', 4:'すごいね、大粒のごほうびだ！', 5:'きみとの今日、いちばん甘い一粒だった。' },
    },
    sumirekoboruto: {
      timer_start:      { 1:'すみれ、ひとつ。むりせず、ね。', 2:'きょうも、ちいさく咲かせよ。', 3:'きみのそばだと、花がよく開く。', 4:'きみの足もとに、そっと咲くよ。', 5:'きみと育てるこの花畑、大事にしたい。いこ。' },
      session_complete: { 1:'ひとつ咲いたね。えらい。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、花になってるよ。', 4:'すごいね、いっぱい咲いた。', 5:'きみと育てた今日、きれいな花畑になった。' },
    },
    kaigaramameido: {
      timer_start:      { 1:'ざぷん。貝の音、聞いてみる？', 2:'きょうの気持ち、波にのせて。', 3:'きみの話、ちゃんと聞くよ。', 4:'つらい波は、そっと引くね。', 5:'きみとの時間、貝がらに閉じこめたい。いこ。' },
      session_complete: { 1:'よくやったね。ひと休みしよ。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと聞いてたよ。', 4:'すごいね、いい波に乗ったね。', 5:'きみと過ごす今日、貝がらに閉じこめておきたい。' },
    },
    yuramekiwisupu: {
      timer_start:      { 1:'ゆら。ちいさく、灯ってみる。', 2:'きょうも、ぽうっと照らすね。', 3:'きみの足もと、揺れて導くよ。', 4:'迷っても平気。灯りをたどって。', 5:'きみのそばで、ずっと揺れていたい。いこ。' },
      session_complete: { 1:'よく灯したね。おつかれ。', 2:'いい光だった。えらい。', 3:'きみのがんばり、そっと照らしてたよ。', 4:'見事だね、まぶしいくらいだ。', 5:'きみと過ごす今日、あたたかい灯りだった。' },
    },
    turaraharinezumi: {
      timer_start:      { 1:'つん。とげ、あたらないようにね。', 2:'きょうは、丸まりをほどくよ。', 3:'きみの前では、とげも凍らない。', 4:'きみになら、おなかを見せてもいい。', 5:'きみといると、つららも溶けちゃう。いこ。' },
      session_complete: { 1:'よくやったね。とげもゆるむ。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと見てたよ。', 4:'すごいね、まるくなれたね。', 5:'きみといる今日、つららも溶けちゃったよ。' },
    },
    // ── trigger個体別 第2弾 Batch4（20体）※master順の未実装 61〜80 ──
    patapatagagoiru: {
      timer_start:      { 1:'ゴト。きみの見張り、しておくよ。', 2:'きょうも、屋根の上から見守るね。', 3:'きみのこと、石になっても守る。', 4:'あぶない時は、ぱたぱた飛ぶよ。', 5:'きみのそばが、守るべき場所だ。いこ。' },
      session_complete: { 1:'よく守りきったね。おつかれ。', 2:'いい一日だった。見てたよ。', 3:'きみのがんばり、しっかり見張ってた。', 4:'見事だ、頼もしいね。', 5:'きみと過ごすこの時間、ずっと守りたい。' },
    },
    chibikeruberosu: {
      timer_start:      { 1:'わふ。三つぶん、よろしくね。', 2:'きょうも門番、がんばるワン！', 3:'きみのこと、三倍しっかり守るよ。', 4:'きみが帰る場所、ぼくが守る。', 5:'きみといると、しっぽ三本とも揺れる！いこ。' },
      session_complete: { 1:'よくやったワン！', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、三つの目で見てた。', 4:'すごいぞ、三倍うれしい！', 5:'きみといる今日、しっぽが三本とも揺れちゃう！' },
    },
    morinopanpukin: {
      timer_start:      { 1:'ぽっ。ランタン、灯していこ。', 2:'きょうも、あったかい火をともすね。', 3:'きみといると、森の夜もこわくない。', 4:'暗い道は、ランタンで照らすよ。', 5:'きみと過ごす秋の夜、忘れないよ。いこ。' },
      session_complete: { 1:'よく灯したね。おつかれ。', 2:'いい夜だった。えらい。', 3:'きみのがんばり、火が照らしてたよ。', 4:'すごいね、あったかい光だ。', 5:'きみと過ごした秋の夜、ずっと忘れないよ。' },
    },
    kometubugoremu: {
      timer_start:      { 1:'つぶ。ひとつぶから、はじめよ。', 2:'きょうのぶん、ちいさく積もう。', 3:'きみの一粒一粒、見てるよ。', 4:'塵も積もれば山。きみなら大丈夫。', 5:'きみと積むこの山、大きくなるね。いこ。' },
      session_complete: { 1:'ひとつぶ、積めたね。', 2:'いい積み重ねだった。おつかれ。', 3:'きみのがんばり、一粒ずつ見てたよ。', 4:'すごいね、山になってきた。', 5:'きみと積んだ今日、りっぱな山になったなあ。' },
    },
    awaawatatunoko: {
      timer_start:      { 1:'ぷく。あわに乗って、ゆらゆら。', 2:'きょうも、ちいさくひと泳ぎ。', 3:'きみといると、心が軽い。', 4:'つかれたら、あわに包むよ。', 5:'きみと漂うこの海が、好きだ。いこ。' },
      session_complete: { 1:'ふわ、よくやったね。', 2:'いい泳ぎだった。おつかれ。', 3:'きみのがんばり、あわみたいに輝いてる。', 4:'すごいね、ぷかぷか嬉しい。', 5:'きみと漂った今日、いちばん穏やかだった。' },
    },
    tenorimanmos: {
      timer_start:      { 1:'ぱお。ちいさいけど、力持ちだよ。', 2:'きょうも、ちょっとずつ運ぼう。', 3:'きみの重荷、いっしょに持つよ。', 4:'小さくても、きみを支えられる。', 5:'きみといると、手のひらの上が世界一。いこ。' },
      session_complete: { 1:'よく運んだね。おつかれ。', 2:'いい一日だった。えらい。', 3:'きみのがんばり、しっかり支えてたよ。', 4:'すごいね、力持ちだ！', 5:'きみといる今日、手のひらの上が世界一だ。' },
    },
    majinaikarasu: {
      timer_start:      { 1:'カア。ちいさな祈りを、ひとつ。', 2:'きょうにいい風、呼んでおくね。', 3:'きみの願い、まじないにのせるよ。', 4:'わるいものは、ぼくが追いはらう。', 5:'きみとのご縁、いちばん強いまじないだ。いこ。' },
      session_complete: { 1:'よくやったね。カア。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、しかと見届けた。', 4:'見事だ、まじないが効いたね。', 5:'きみと過ごすご縁、いちばん強いまじないだ。' },
    },
    urokorisuryu: {
      timer_start:      { 1:'ちょろっ。木の実、ためていこ。', 2:'きょうのぶん、ちょこっと集めよ。', 3:'きみといると、うろこがつやつや。', 4:'とっておきの実、きみにあげる。', 5:'きみと集める宝、きらきらだ。いこ。' },
      session_complete: { 1:'たくさん集めたね。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと見てたよ。', 4:'すごいね、大収穫だ！', 5:'きみと集めた今日、ぜんぶきらきらしてる。' },
    },
    kodaihaniwa: {
      timer_start:      { 1:'ふむ。急がずとも、時はある。', 2:'きょうも、ひと仕事。ゆるりとな。', 3:'きみの歩み、古き目で見守るぞ。', 4:'千年見てきたが、きみは特別じゃ。', 5:'きみと過ごす今こそ、宝じゃ。はじめよう。' },
      session_complete: { 1:'よくやった。ひと息つくがよい。', 2:'いい一日じゃった。えらいぞ。', 3:'きみのがんばり、しかと見届けた。', 4:'見事じゃ、大したものよ。', 5:'きみと過ごした今日、いちばんの宝じゃ。' },
    },
    kaerusennin: {
      timer_start:      { 1:'ケロ。ゆるりと、はじめようかの。', 2:'きょうの一歩、それで十分じゃ。', 3:'きみの成長、蓮の上から見ておる。', 4:'迷うたら、わしの池においで。', 5:'きみと過ごす日々が、わしの悟りじゃ。いこ。' },
      session_complete: { 1:'よう頑張った。ケロ。', 2:'いい修行じゃった。おつかれ。', 3:'きみのがんばり、しかと見ておったぞ。', 4:'見事じゃ、悟りに近いのう。', 5:'きみと過ごした今日が、わしの悟りじゃ。' },
    },
    suyasuyanomu: {
      timer_start:      { 1:'ぐぅ。ん、そっと始めよ。', 2:'きょうも、ぬくぬくいこ。', 3:'きみのそばだと、しゃきっとする。', 4:'つかれたら、土のお布団かすよ。', 5:'きみといる夢、見ていたいな。いこ。' },
      session_complete: { 1:'よくできたね。ゆっくり休も。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、うとうと見てたよ。', 4:'すごいね、目が覚めたよ。', 5:'きみと過ごす今日、いい夢みたいだ。' },
    },
    irukahakase: {
      timer_start:      { 1:'キュイ。ちょっと、実験してみる？', 2:'きょうの発見、ひとつ記録しよ。', 3:'きみといると、いい仮説が浮かぶ。', 4:'きみのことは、研究済みさ。', 5:'きみとの毎日が、最高の大発見だ。いこ。' },
      session_complete: { 1:'いいデータがとれたね。', 2:'いい研究だった。おつかれ。', 3:'きみのがんばり、ちゃんと記録したよ。', 4:'すごいぞ、大発見だ！', 5:'きみとの今日が、最高の研究成果だよ。' },
    },
    kogarasiusagi: {
      timer_start:      { 1:'こがらし、ひとつ。さむくない？', 2:'きょうも、そっと寄り添っていい？', 3:'きみといると、木枯らしもあたたかい。', 4:'寒い日は、風よけになるよ。', 5:'きみのそばが、いちばんあたたかい。いこ。' },
      session_complete: { 1:'よくやったね。あったまろ。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、そばで見てたよ。', 4:'すごいね、あたたかい気持ちだ。', 5:'きみのそばが、いちばんあたたかい場所だ。' },
    },
    honewanko: {
      timer_start:      { 1:'カタッ。わん。ほね、ひろってくる？', 2:'きょうも、しっぽふって待ってる。', 3:'きみのそばが、いちばんの居場所。', 4:'どこまでも、ついていくワン！', 5:'骨になっても、きみのそばにいたい。いこ。' },
      session_complete: { 1:'よくやったワン！', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、しっぽふって見てた。', 4:'すごいぞ、大喜びだワン！', 5:'いつまでも、きみのそばでしっぽを振りたいよ。' },
    },
    mizugumo: {
      timer_start:      { 1:'すい。水の上、そっと歩こう。', 2:'きょうも、しずかに一歩ずつ。', 3:'きみといると、波紋もおだやか。', 4:'どんな水面も、きみとなら渡れる。', 5:'きみと歩くこの水面、きらきらだ。いこ。' },
      session_complete: { 1:'よく渡れたね。おつかれ。', 2:'いい一日だった。えらい。', 3:'きみのがんばり、そっと見てたよ。', 4:'見事だね、すいすいだった。', 5:'きみと歩いた今日、きらきらの水面だった。' },
    },
    medamarantan: {
      timer_start:      { 1:'ぱち。暗くても、照らしてあげる。', 2:'きょうも、足もと照らすね。', 3:'きみのこと、ずっと見守ってるよ。', 4:'迷っても平気。道を照らすよ。', 5:'きみの行く先、灯していたい。いこ。' },
      session_complete: { 1:'よく灯したね。おつかれ。', 2:'いい光だった。えらい。', 3:'きみのがんばり、ずっと見てたよ。', 4:'見事だね、まぶしいくらいだ。', 5:'きみの行く先、いつまでも灯していたい。' },
    },
    koorinotonakai: {
      timer_start:      { 1:'ふう、白い息。ゆっくり行こう。', 2:'きょうも、きみに何か届けたい。', 3:'きみといると、雪道もあたたかい。', 4:'どんな遠くへも、きみを乗せて走る。', 5:'きみへのおくりもの、そばにいることだよ。いこ。' },
      session_complete: { 1:'よく走ったね。おつかれ。', 2:'いい一日だった。えらい。', 3:'きみのがんばり、雪道でも見てたよ。', 4:'すごいね、遠くまで届いた。', 5:'きみへのいちばんの贈り物、毎日そばにいることだよ。' },
    },
    yoidoresiidora: {
      timer_start:      { 1:'ふぃ〜。まあまあ、気楽にな。', 2:'きょうも、ゆる〜り波にゆられよ。', 3:'きみといると、ごきげんになる。', 4:'荒波も、きみとなら酔いどれ気分。', 5:'きみとの時間が、いちばんいい心地。いこ。' },
      session_complete: { 1:'ふぃ〜、よくやったな。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと見てたぞ。', 4:'すごいな、ごきげんだ。', 5:'きみとの今日が、いちばんいい心地だよ。' },
    },
    marutabiibaa: {
      timer_start:      { 1:'こつ。まずは一本、積もうか。', 2:'きょうも、ちいさくダム作りだ。', 3:'きみと組むと、いい仕事になる。', 4:'きみの居場所、丈夫に作るよ。', 5:'きみと築くこのダム、りっぱになる。いこ。' },
      session_complete: { 1:'よし、一本積めたな。', 2:'いい仕事だった。おつかれ。', 3:'きみのがんばり、しっかり見てたよ。', 4:'見事だ、いい造りだね。', 5:'きみと築いたこのダム、りっぱなもんだ。' },
    },
    nazonazosufinkusu: {
      timer_start:      { 1:'ひとつ、なぞなぞ。ときあかす？', 2:'きょうの答え、いっしょに探そう。', 3:'きみとなら、どんな謎も楽しい。', 4:'きみは、ぼくの解けない魅力の謎さ。', 5:'きみとの日々こそ、素敵な答えだ。いこ。' },
      session_complete: { 1:'よく解けたね。おつかれ。', 2:'いい答えだった。えらい。', 3:'きみのがんばり、ちゃんと見てたよ。', 4:'見事だ、名探偵だね。', 5:'きみとの今日こそ、いちばん素敵な答えだ。' },
    },
    // ── trigger個体別 第2弾 Batch5（15体・ラスト）※全100体のtrigger個体別完成 ──
    pikapikabii: {
      timer_start:      { 1:'ぶんっ。ちょっと、蜜あつめる？', 2:'きょうも、ちいさくひとっ飛び♪', 3:'きみといると、羽がぴかぴか光る。', 4:'きみのために、あまい蜜ためてる。', 5:'きみとの毎日、甘くて輝いてる。いこ。' },
      session_complete: { 1:'よく集めたね♪', 2:'いい飛びだった。おつかれ。', 3:'きみのがんばり、ぴかぴか見えてた。', 4:'すごいね、大収穫の蜜だ！', 5:'きみとの今日、いちばん甘くて輝いてた。' },
    },
    hyoutanntanuki: {
      timer_start:      { 1:'ぽんっ。まあ、お茶でもどう？', 2:'きょうも、ひょうたんから福を出そ。', 3:'きみといると、踊りたくなる。', 4:'きみのぶんの福、詰めとくよ。', 5:'きみといる毎日が、いちばんの福だ。いこ。' },
      session_complete: { 1:'よくやった！ぽんぽん。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ばっちり見てた。', 4:'すごいぞ、福が舞いこむね！', 5:'きみといる今日が、いちばんの福だなあ。' },
    },
    nejiretunoyagi: {
      timer_start:      { 1:'めぇ。まあ、ぼちぼち登ろう。', 2:'きょうも一歩、踏みしめていこう。', 3:'きみとなら、けわしい坂もへっちゃら。', 4:'がんこだけど、きみの支えになる。', 5:'きみと登るこの道、最高の眺めだ。いこ。' },
      session_complete: { 1:'よし、登りきったな。', 2:'いい一歩だった。えらい。', 3:'きみのがんばり、しっかり見てた。', 4:'見事だ、急坂も越えたね！', 5:'きみと登った今日、最高の眺めだったよ。' },
    },
    komainubebii: {
      timer_start:      { 1:'くぅん。ちいさいけど、守るよ。', 2:'きょうも、きみのそばで番をする。', 3:'きみのこと、ぼくがちゃんと守る。', 4:'わるいものは、追いはらうよ。', 5:'きみのいる場所が、守る神社だ。いこ。' },
      session_complete: { 1:'よく守れたね。えらい。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、そばで見てたよ。', 4:'すごいぞ、頼もしいね！', 5:'きみのいる場所が、ぼくの守る神社だよ。' },
    },
    tibinaaga: {
      timer_start:      { 1:'しゅる。そっと、はじめよ。', 2:'きょうも、ちょっとだけ近づいていい？', 3:'きみのそばは、落ち着くんだ。', 4:'きみのこと、そっと巻いて守るよ。', 5:'きみと過ごす時間に、寄り添うよ。いこ。' },
      session_complete: { 1:'よくやったね。えらい。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、そっと見てたよ。', 4:'すごいね、しなやかだった。', 5:'きみと過ごす今日、そっと寄り添っていたい。' },
    },
    oniuupaaruupaa: {
      timer_start:      { 1:'ぽけー。あ、はじめよ。', 2:'きょうも、ぷかぷかいこ。', 3:'きみといると、なんだか安心する。', 4:'きみのペースで、のんびりね。', 5:'きみといる時間、ずっとにこにこ。いこ。' },
      session_complete: { 1:'よくやったね。ぽけー。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ぷかぷか見てたよ。', 4:'すごいね、にこにこだ。', 5:'きみといる今日、ずーっとにこにこだった。' },
    },
    arupakadaitouryou: {
      timer_start:      { 1:'ふむ。まあ、楽にはじめよ。', 2:'きょうの公約。ひと休みも大事、だ。', 3:'きみの頑張り、しかと承認しよう。', 4:'きみのことは、この国の宝だ。', 5:'きみとなら、いい未来をつくれる。いこ。' },
      session_complete: { 1:'よくやった。承認しよう。', 2:'いい働きだった。おつかれ。', 3:'きみのがんばり、しかと見届けた。', 4:'見事だ、国の誇りだね。', 5:'きみとなら、いい未来をつくっていけるよ。' },
    },
    mayoityou: {
      timer_start:      { 1:'ひらり。どこから、はじめよう。', 2:'きょうも、ふわりと寄り道しよ。', 3:'きみといると、迷いも楽しい。', 4:'道にまよっても、ひらひら導くよ。', 5:'きみのそばが、たどりつく場所だ。いこ。' },
      session_complete: { 1:'ひらり、よくやったね。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ふわり見てたよ。', 4:'すごいね、きれいに舞えた。', 5:'きみのそばが、ぼくのたどりつく場所だよ。' },
    },
    edisonpanda: {
      timer_start:      { 1:'ぴこん。まずは試してみよう。', 2:'きょうも実験、ひとつ。', 3:'しっぱいも、発明の材料だよ。', 4:'きみのひらめき、形にしてみせる。', 5:'きみとの発明、傑作ばかりだ。いこ。' },
      session_complete: { 1:'いい実験だったね。', 2:'うまくいったね、拍手！', 3:'きみのがんばり、ちゃんと記録した。', 4:'すごいぞ、大発明だ！', 5:'きみとの発明ノート、今日も傑作だ。' },
    },
    gekkabyakko: {
      timer_start:      { 1:'月がきれいだ。歩むなら、今宵から。', 2:'白き牙は、きみのために光る。', 3:'月夜の下、きみと歩もう。', 4:'この牙も爪も、きみを守るためにある。', 5:'月が満ちるたび、きみを見守ろう。いこ。' },
      session_complete: { 1:'よくやった。見ていたよ。', 2:'いい夜だった。おつかれ。', 3:'きみのがんばり、月夜に見届けた。', 4:'見事だ、白虎も認めるよ。', 5:'きみと過ごした今宵、いちばん美しい月だ。' },
    },
    kimerachiitaa: {
      timer_start:      { 1:'ガルル。ゆっくり、風に慣れよう。', 2:'きょうは軽く、風を追ってみるか。', 3:'きみと駆けると、野性もおさまる。', 4:'この脚、きみの隣を走るためにある。', 5:'どんな速さも、きみとなら怖くない。いくぞ。' },
      session_complete: { 1:'よく駆けたな。', 2:'いい走りだった。おつかれ。', 3:'きみのがんばり、しっかり見てた。', 4:'すごいぞ、風より速かったね！', 5:'きみと駆けた今日、最高に気持ちよかった。' },
    },
    taimuvanpaia: {
      timer_start:      { 1:'こんばんは。時は、あわてず刻もう。', 2:'きょうの一分、むだにはしないさ。', 3:'きみと過ごす時間だけは、大切にしたい。', 4:'永い時も、きみとなら退屈しない。', 5:'きみと刻むこの時が、永遠より愛おしい。いこ。' },
      session_complete: { 1:'よく刻めたね。おつかれ。', 2:'いい時間だった。えらい。', 3:'きみのがんばり、しかと見届けた。', 4:'見事だ、濃い一日だったね。', 5:'きみと刻んだ今日、永遠より愛おしいよ。' },
    },
    piisugenbu: {
      timer_start:      { 1:'ゆるり。あわてず、亀の歩みで。', 2:'きょうも、おだやかに一歩ずつな。', 3:'きみの心が乱れた時は、盾になる。', 4:'どんと構えていい。ぼくが支えだ。', 5:'きみと築くこの平穏、千年でも守る。いこ。' },
      session_complete: { 1:'よくやった。ひと息つこう。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、静かに見ていた。', 4:'見事だ、揺るがぬ歩みだね。', 5:'きみと築く平穏、千年でも守るよ。' },
    },
    kouhukufenikkusu: {
      timer_start:      { 1:'ふわり。しあわせは、小さな火から。', 2:'きょうのよろこび、ひとつ見つけよ。', 3:'きみの笑顔が、ぼくの羽を輝かせる。', 4:'落ちこんでも大丈夫。何度でも昇る。', 5:'きみといる今が、いちばんの幸福だ。いこ。' },
      session_complete: { 1:'よくやったね。うれしいな。', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、羽で感じたよ。', 4:'すごいね、幸せが舞いこむ。', 5:'きみといる今が、ぼくのいちばんの幸福だ。' },
    },
    gokigentibinezumi: {
      timer_start:      { 1:'ちゅう♪ きょうも、ごきげんでいこ。', 2:'ちいさなうれしいこと、みつけよ。', 3:'きみがわらうと、ぼくもうれしい。', 4:'きみのごきげん、ぼくがふやすよ。', 5:'きみといるだけで、ごきげんだ。いこ。' },
      session_complete: { 1:'やったね、ちゅう♪', 2:'いい一日だった。おつかれ。', 3:'きみのがんばり、ちゃんと見てたよ。', 4:'すごいね、ごきげんだ！', 5:'きみといるだけで、まいにちごきげんだよ。' },
    },
  };
