...
// ═══════════════════════════════════════════════════════
//  ウィジェットのドラッグ並べ替えは廃止した（2026-08-05 / 三層化 L-1）
//  ホームを「いま / きょう / ふりかえり」の3層に分けたことで、
//  層の順番そのものが優先度を表すようになり、自由な並べ替えと矛盾したため。
//  仕様: docs/spec_home_three_layers.md §3
//  保存キー gq_widget_order は不要になったので一度だけ掃除する。
// ═══════════════════════════════════════════════════════
localStorage.removeItem('gq_widget_order');
